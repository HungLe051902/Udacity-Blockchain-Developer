...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Hung Le Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == token1Owner || msg.sender == token2Owner, "Not authorize");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address _from1 = ownerOf(_tokenId);
        require(msg.sender == _from1);
        transferFrom(_from1, _to1, _tokenId);
    }
}

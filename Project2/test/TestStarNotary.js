...
it('can add the star name and star symbol properly', async() => {
    ...
    let instance = await StarNotary.deployed();
    assert.equal(await instance.name(), "Hung Le Token");
    assert.equal(await instance.symbol(), "HLT");
});
...
it('lets a user transfer a star', async() => {
    ...
    let instance = await StarNotary.deployed();
    let tokenId = 101;
    await instance.createStar('Awesome Star 101!', tokenId, {from: accounts[0]});

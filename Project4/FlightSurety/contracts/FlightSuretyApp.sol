...
contract FlightSuretyApp {
    ...
    */
    ...
    {
        require(flightSuretyData.isAirlineActive(msg.sender), "This account doesn't have enough funds");
        _;
    }

    modifier requireAirlineNotVoted(address airline) {
        require(!checkIfContains(airlineVoters[airline]), "You already voted to register this airline.");
        _;
    }
    ...
    */   
    ...
    function checkIfContains(address[] memory voters) internal view returns(bool hasVoted){
        hasVoted = false;
    ...
    */  
                ...
                
    {
        ...
        require(flights[key].isRegistered == false, "Flight is registered");
        flights[key] = Flight({
                                isRegistered: true,
                                flightCode: flight,
